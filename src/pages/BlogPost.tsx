...
const postsContent: Record<string, { title: string; date: string; category: string; content: string[] }> = {
  "slow-down": {
    ...
    content: [
      ...
      "And I let it.",
      "I’m ending January without answers neatly lined up.", "There are still things unfolding.", "Still emotions I haven’t named yet.",
      "But I feel lighter.",
      ...
      "And for the first time in a long time.", "I’m allowing myself to take it.",
    ],
  },
  "choose-myself": {
