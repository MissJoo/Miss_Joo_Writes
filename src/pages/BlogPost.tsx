...
const postsContent: Record<string, { title: string; date: string; category: string; content: string[] }> = {
  "qatar-days-filipina": {
    ...
    content: [
      ...
      "The sun rises with a kind of strength that does not ask for permission. It touches the buildings, the roads, the glass towers, the sand-colored walls, and even the parts of you that you try to keep hidden. Some mornings, I look outside and see the same city I have been living in for years, yet it still feels like I am learning how to belong here.",
      "Life in Qatar, through my eyes as a Filipina woman, is not just about work, salary, malls, buildings, or the idea of living abroad. It is a quiet combination of survival, adjustment, longing, gratitude, and becoming someone you never imagined you would need to be.",
      "Some people see Qatar as a place of opportunity. And it is. But for many of us who came here from the Philippines, Qatar is also a place where we learned how strong we could be when no one was watching.",
      ...
      "Back home, even ordinary days have noise. Neighbors talking, family members moving around the house, tricycles passing by, someone cooking, someone calling your name, someone asking where you are going. In the Philippines, life often feels close, warm, and crowded in a way that can sometimes be tiring but also comforting.",
      "In Qatar, the silence can feel wider.",
      ...
      "As a Filipina woman, I learned that being strong does not always look dramatic. Sometimes strength is simply showing up. It is doing your job properly. It is sending money home. It is renewing documents, managing expenses, handling homesickness, adjusting to culture, respecting rules, and still trying to keep your softness alive.",
      "Because living abroad can change you.",
      "It can make you practical. It can make you careful. It can make you mature faster. You learn how to solve problems alone. You learn how to comfort yourself. You learn how to be patient in a country that is not yours but slowly becomes part of your story.",
      "But I also believe that living in Qatar has taught me something beautiful: you can grow quietly.",
      "Not every transformation has to be loud. Not every chapter has to be posted, explained, or understood by everyone. Some growth happens while walking under the heat with tired feet. Some growth happens inside small rooms, after long workdays, when you sit with yourself and realize you survived another day. Some growth happens when you buy coffee alone, dress nicely for yourself, take photos of the sky, and remind yourself that life is still happening even while you are waiting for your dreams to unfold.",
      ...
      "I think that is one of the quiet lessons Qatar gave me: not all happiness is big. Sometimes happiness is simply having enough peace to breathe.",
      "There were moments when I thought I had to have everything figured out by now. I thought by a certain age, life should look more stable, more successful, more complete. But living abroad taught me that life does not always follow the timeline we imagined.",
      ...
      "Qatar has seen many versions of me.\n\nThe version of me who was still adjusting.\nThe version of me who missed home too much.\nThe version of me who tried to be strong even when she was confused.\nThe version of me who cared too much about people who did not meet her halfway.\nThe version of me who slowly learned how to protect her heart.\nThe version of me who still believes in softness, even after life required her to be strong.",
      ...
      "Qatar days taught me that strength can be quiet. That loneliness can teach you about yourself. That beauty can exist even in routine. That being far from home does not mean you are lost. Sometimes, it means you are being shaped in a place you never expected to become part of your story.",
      "And maybe one day, when I look back at this chapter, I will not only remember the heat, the distance, the hard days, or the homesickness.",
      "I will remember the woman I became here.\n\nThe woman who learned how to walk through unfamiliar streets with courage.\nThe woman who made a life out of small beginnings.\nThe woman who kept going even when her heart was tired.\nThe woman who found softness in a city of glass, sand, sunlight, and silence.",
      "Qatar, through my eyes, is not just a place where I live.",
      "It is a chapter that taught me how to grow quietly, love myself deeper, and become stronger without losing the gentle parts of who I am.",
    ]
  },
